...
data = {
    ...
    'rain': all_data["Prec.day(mm)"].apply(lambda x: 1 if x > 0 else 0)
}
...
def should_water_plants(temperature, humidity):
    ...
    return "No Watering Plants" if water_prediction[0] == 1 else "Watering Plants"
...
while True:
    ...
    mqttc.publish("sensor/data", mqtt_payload)
